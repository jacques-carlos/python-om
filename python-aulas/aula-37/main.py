...
print(f'ID:{Pessoa.gera_id()}')                             # embora seja independente de classe ou objeto, o método estático é chamado pela classe

# criando um objeto a partir de um método de classe
p2 = Pessoa.por_ano_nascimento('João', 1993)
print(p2.nome, p2.idade)
print(f'ID:{p2.gera_id()}')                                 # o método estático também funciona sendo chamado por uma instância